...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Flax Flower")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the FlaxFlower is.
    [Yield(typeof(FlaxFlowerItem), typeof(GatheringSkill), new float[] {1f, 1.4f, 1.5f, 1.6f, 1.7f, 1.8f, 1.9f, 2.0f})]
    ...
    public partial class FlaxFlowerItem : FoodItem
    {
